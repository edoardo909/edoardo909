...
(function () {
	...
	if (isNotInIde) {
		...
		ICE.startEdit = function() {
			var siteRoot = ICE.getSiteRoot();
			var siteRootParts = siteRoot.replace(/\/$/gi, "").split("../index.html");
			...
			var redirecttoParts = redirectTo.split("../index.html");
			...
			redirectTo = redirecttoParts.join("../index.html");
